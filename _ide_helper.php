 ...
 * Generated for Laravel 5.7.16 on 2019-03-29 11:28:38.
 *
...
namespace App\Modules\SeoAgent\Facades { 
    ...
    class SeoAgentService {
         ...
         * @static 
         */ 
        public static function getDraftData($per_page, $page, $orderBy, $orderDesc, $wildSearch = null, $type = null, $status = null, $md5 = null)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::getDraftData($per_page, $page, $orderBy, $orderDesc, $wildSearch, $type, $status, $md5);
        }
        ...
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::deleteDraft($id);
        }
         ...
         *
         * @param $id
         * @param \App\Modules\SeoAgent\Services\MetaSchemaEloquent $data
         * @return \Illuminate\Database\Eloquent\Builder|\Illuminate\Database\Eloquent\Model|null|object 
         * @static 
         */ 
        public static function updateDraftData($id, $data)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::updateDraftData($id, $data);
        }
         ...
         *
         * @param $prepare
         * @return \App\Modules\SeoAgent\Services\SeoAgentBaseModel|array 
         * @static 
         */ 
        public static function createCurrentData($prepare)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::createCurrentData($prepare);
        }
         ...
         * @static 
         */ 
        public static function getOnlyDraftData($perPage, $page)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::getOnlyDraftData($perPage, $page);
        }
         ...
         * @static 
         */ 
        public static function getCurrentDataByHash($hash)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::getCurrentDataByHash($hash);
        }
         ...
         * @static 
         */ 
        public static function updateCurrentDataByHash($hash, $data)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::updateCurrentDataByHash($hash, $data);
        }
         ...
         *
         * @param $metaId
         * @return \App\Modules\SeoAgent\Services\SeoAgentRepository[]|\Illuminate\Database\Eloquent\Collection 
         * @static 
         */ 
        public static function getHistoryByMetaHash($metaId)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::getHistoryByMetaHash($metaId);
        }
         ...
         * @static 
         */ 
        public static function updateStatus($hash, $comments, $status)
        {
            return \App\Modules\SeoAgent\Services\SeoAgentService::updateStatus($hash, $comments, $status);
        }
...
namespace TimeHunter\LaravelApiModuleGenerator\Facades { 
    ...
    class LaravelApiModuleGenerator {
         ...
         * @static 
         */ 
        public static function publish($schema)
        {
            return \TimeHunter\LaravelApiModuleGenerator\LaravelApiModuleGenerator::publish($schema);
        }
...
namespace TimeHunter\LaravelFileGenerator\Facades { 
    ...
    class LaravelFileGenerator {
        ...
        {
            return \TimeHunter\LaravelFileGenerator\LaravelFileGenerator::getGenerator($object);
        }
         ...
         * @static 
         */ 
        public static function publish($objects = null)
        {
            return \TimeHunter\LaravelFileGenerator\LaravelFileGenerator::publish($objects);
        }
         ...
         * @static 
         */ 
        public static function preview($object)
        {
            return \TimeHunter\LaravelFileGenerator\LaravelFileGenerator::preview($object);
        }
...
namespace  { 
    ...
    class SeoAgentService extends \App\Modules\SeoAgent\Facades\SeoAgentService {}

    class LaravelApiModuleGenerator extends \TimeHunter\LaravelApiModuleGenerator\Facades\LaravelApiModuleGenerator {}

    class LaravelFileGenerator extends \TimeHunter\LaravelFileGenerator\Facades\LaravelFileGenerator {}
